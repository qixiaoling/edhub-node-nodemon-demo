...
const filterResult = inventors.filter((inv)=>{
...
const mapResult = inventors.map((inv)=>{
    return inv.year;
})
...
const mapResult2 = inventors.map((inv)=>{
...
const sortOne = inventors.sort((a,b)=>{
...
const sortTwo = inventors.sort((a,b)=>{
...
const findInv = inventors.find((inv)=>{
