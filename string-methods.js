...
const arrayLastWord = [fruit, vegetable]
for(let i=0; i<arrayLastWord.length; i++){
    console.log(arrayLastWord[i].slice(-1))
    //console.log(arrayLastWord[i].charAt(arrayLastWord[i].length-1)) 不可以
}
...
console.log(story.indexOf("Fantastisch"))
console.log(story.substr(0,53))
