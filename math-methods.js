...
const omtrekOne = 4 * Math.PI
console.log(omtrekOne)
...
const omtrekTwo = Math.round(12 * Math.PI)
console.log(omtrekTwo)
...
if(Math.random()>0.5) {
    console.log(Math.random() + "Het glas is halfvol")
}else{
    console.log(Math.random() + "Het glas is half leeg")
}