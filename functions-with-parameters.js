...
const hiJan = greeter('Jan')
console.log(hiJan)
const hiKees = greeter('Kees')
console.log(hiKees)
/* Opdracht 2 */
...
function calculateDogYears (dogAge){
    return(console.log("Jouw hond is " + dogAge * 7 + " jaar oud in mensenjaren."))
}
calculateDogYears(6)
calculateDogYears(2)
...
function wrapper ( word, charater){
    return (charater+word+charater)
}
const a = wrapper("bril", "*")
const b = wrapper("beep", "_")
const c = wrapper("kaas", "Q")
console.log(a)
console.log(b)
console.log(c)
...
console.log(createDetailString("Kees", "Klassen", "brandweerman"))